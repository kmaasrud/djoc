...
export class Djoc {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Djoc.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_djoc_free(ptr);
    }
    /**
    * @returns {Djoc}
    */
    static new() {
        const ret = wasm.djoc_new();
        return Djoc.__wrap(ret);
    }
    /**
    ...
    */
    update_doc(content) {
        ...
        wasm.djoc_update_doc(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {string}
    */
    render() {
        ...
        try {
            ...
            wasm.djoc_render(retptr, this.__wbg_ptr);
    ...
    */
    render_latex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.djoc_render_latex(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    set_title(title) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.djoc_set_title(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @param {string} author
    */
    set_author(author) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.djoc_set_author(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('djoc_sandbox_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
